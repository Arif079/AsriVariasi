...
class Transaction extends CI_Controller {
    ...
    public function json_sparepart() {
        $addFunc = "addSparepartCart({id:<get-id>,kditem:'<get-kditem>',kdjob:'<get-kdjob>',namajob:'<get-namajob>',name:'<get-name>',satuan:'<get-satuankecil>',price:<get-price>,priceqq:<get-priceqq>,stock:<get-stock>,hpp:'<get-coahpp>',jual:'<get-coapenjualan>',sedia:'<get-coapersediaan>'})";
