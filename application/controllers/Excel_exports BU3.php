        ...
        foreach ($selectedCOA as $coa_value) {
            ...
            if (!empty($grouped_data) && is_array($grouped_data)) {
                foreach ($grouped_data as $data) {
                    ...
                    $total_debet_transaksi = $data->total_debet;
                    $total_kredit_transaksi = $data->total_kredit;
                ...
                // Optionally, log or handle the case where no data is returned for this COA
                log_message('info', 'No data returned from get_neraca for COA: ' . $coa_value);
            }
        }
