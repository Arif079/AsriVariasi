                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Penambahan paket</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="card">
                <div class="card-header">
                    <a href="<?=base_url("Paket/new");?>" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah</a>
                </div>
                <div class="card-body">
        ...
        <script>
                ...
                $("body").on("click",".btn-view",function(){
                    ...
                    jQuery.getJSON("<?=base_url("Paket/detail");?>/"+id,function(data){
