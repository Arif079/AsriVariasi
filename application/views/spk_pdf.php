...
<body>
    <div class="header">
        ...
        <span class="title"><?=$fetch->spkid?></span>
    </div>
    ...
    <tbody>
        <tr>
            ...
            <td class="no-td" style="text-align: left; "><?=$fetch->customer?></td>
        ...
        <tr>
            ...
            <td class="no-td" style="text-align: left;">:</td>
            <td style="white-space: wrap;" class="no-td" style="text-align: left; "><?=$fetch->alamat?></td>
        ...
        <tr>
            ...
            <td class="no-td" style="text-align: left;">:</td>
            <td class="no-td" style="text-align: left; "><?=$fetch->npwp?></td>
        ...
        <tr>
            ...
            <td class="no-td" style="text-align: left;">:</td>
            <td class="no-td" style="text-align: left;" ><?=$fetch->nama_qq?></td>
        ...
        <tr>
            ...
            <td class="no-td" style="text-align: left;">:</td>
            <td class="no-td" style="text-align: left; "><?=$fetch->notelp?></td>
        ...
        <tr>
            ...
            <td class="no-td" style="text-align: left;">:</td>
            <td class="no-td" style="text-align: left; "><?=$fetch->plat?></td>
        ...
        <tr>
            ...
            <td class="no-td" style="text-align: left;">:</td>
            <td class="no-td" style="text-align: left; "><?=$fetch->sales?></td>
            <td class="no-td" style="text-align: left;"></td>
            <td class="no-td" style="text-align: left;"></td>
            <td class="no-td" style="text-align: left; "></td>
    ...
    <table width="100%" style="margin-top:12px;" >
        ...
        <tfoot>
            <tr>
                ...
                <td class="currency-total" style="text-align:right;font-size: 11px;"><?=number_format($fetch->total,0,",",".");?></td>
            </tr>
        </tfoot>
    </table>
    <div class="wrapper">
    ...
    <tbody>
    <?php
    $staticRowCount = 7; // Set the static number of rows
    $rowspan = $staticRowCount; // Calculate rowspan value

    for ($counter = 1; $counter <= $staticRowCount; $counter++) {
    ?>
        <tr>
            <td class="m-td" style="font-size:10px"></td>
            <td class="m-td"></td>
            <td class="m-td"></td>
            <td class="m-td"></td>
            <td class="m-td"></td>
            <?php if ($counter === 1) { // Check if it's the first iteration ?>
