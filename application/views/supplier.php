                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                                ...
                                <input type="text" name="kdsupp" class="form-control"/>
                            </div>
                            <div class="form-group">
        ...
        function filterSelect(select, filterValue) {
            ...
            $("body").on("click",".btn-edit",function(){
                ...
                jQuery.getJSON("<?=base_url("supplier/get");?>/"+id,function(data){
                    ...
                    jQuery("#compose form input[name=kdsupp]").val(data.kdsupp);
                    ...
                    jQuery("select[name=coa]").val(data.coa);
            ...
            $(".btn-confirm").on("click",function() {
                var form = {
                    "kdsupp": jQuery("#compose input[name=kdsupp]").val(),
                    ...
                    "coa":jQuery("select[name=coa]").val(),
                }
