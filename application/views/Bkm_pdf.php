...
<body>
    <div class="header">
    <span class="title"><?=$bkmno->bkmno;?></span>
    <?php
    ...
    <div class="wrapper clearfix" >
        <div style="form-row" > 
            ...
            // Get the first element from the $details array
            $firstDetail = reset($details);

            // Check if $firstDetail is not empty before accessing its properties
            if (!empty($firstDetail)) {
                $firstNtrn = $firstDetail->spkid;
                // Now $firstNtrn contains the value of 'ntrn' from the first element in $details
            } else {
                // Handle the case when $details is empty
                $firstNtrn = "No details available";
            }
            ?>

            <!-- Now you can use $firstNtrn wherever you need it in your HTML -->
            <tr>
                <td style="border:none;font-size:12px;">No INV</td>
                <td style="border:none;font-size:12px;">:</td>
                <td style="border:none;font-size:12px;" colspan="2"><?=$inv->noinvoice?></td>
            </tr>
            ...
            <tr>
                <td style="border:none;font-size:12px;"colspan="4">Terima Dari</td>
            <tr> 
            <tr>
                <td style="border:none;font-size:12px">Customer</td>
                <td style="border:none;font-size:12px">:</td>
            ...
            <tr>
                ...
                <td style="border:none;font-size:12px">:</td>
                <td style="border:none;font-size:12px"colspan="2"><?=$fetch->address?></td>
            <tr> 
            ...
            <tr> 
                ...
                // Check if $firstDetail is not empty before accessing its properties
                if (!empty($firstDetail)) {
                    $firstUraian = $firstDetail->uraian;
                    // Now $firstUraian contains the value of 'uraian' from the first element in $details
                } else {
                    // Handle the case when $details is empty
                    $firstUraian = "No details available";
                }
            ?>
            <tr>
                <td style="border:none;font-size:12px"></td>
                <td style="border:none;font-size:12px"></td>
                <td style="border:none;font-size:12px"colspan="2"><?=$firstUraian?></td>
            <tr> 
    ...
    <table class="table-mid" width="100%">
        ...
        <?php
            ...
            ?>
                ...
                <tr>
                    <td style="border-bottom:none;text-align:center" width="30%"><?=$detail->coad;?></td>
                    <td style="border-bottom:none;" width="50%"><?=($detail->uraian);?></td>
                    <td class="currency" style="border-bottom:none;text-align:right" width="20%"><?=number_format($detail->bayar,0,",",".");?></td>
                </tr>
