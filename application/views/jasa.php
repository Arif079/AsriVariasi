        ...
        <div class="content mt-3">
            <div class="card">
                <div class="card-header">
                    <button class="btn btn-success btn-sm btn-show-add" data-toggle="modal" data-target="#compose"><i class="fa fa-plus"></i> Tambah Jasa</button>
                </div>
                <div class="card-body">
            ...
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="largeModalLabel">Tambah Jasa</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>Harga Sparepart QQ</label>
        ...
        <script>
                ...
                $(".btn-show-add").on("click",function(){
                    ...
                    jQuery("#compose .modal-title").html("Tambah jasa");
                    jQuery("#compose-form").attr("action","<?=base_url("jasa/insert");?>");
                });
                ...
                function deleteData(id) {
                    jQuery.getJSON("<?=base_url();?>jasa/delete/"+id,function(data){
                        if(data.status) {
                            jQuery("#delete").modal("toggle");
                            jQuery("#data").DataTable().ajax.reload(null,true);
                            Swal.fire(
                ...
                $("body").on("click",".btn-edit",function(){
                    ...
                    jQuery("#compose .modal-title").html("Edit Jasa");
                    jQuery("#compose-form").attr("action","<?=base_url();?>jasa/update/"+id);
                ...
                var action = "<?= base_url(); ?>jasa/updatePrice/" + id;
