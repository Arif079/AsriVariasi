<div class="breadcrumbs">
        ...
        <div class="content mt-3">
                ...
                <div class="card-body">
                    <form>
                        <div class="form-group">
                            ...
                            <input type="text" name="keterangan" class="form-control ket" >
                            <label>PPN :</label>
                            <select class="form-control ppn">
                                <option value="">-- Pilih --</option>
                                <?php
                                foreach($ppn as $vat) {
                                    echo '<option value="'.$vat->ppn.'">'.$vat->name.'</option>
                                    ';
                                }
                                ?>
                            </select>
            ...
            <div class="text-right mb-4">
                <button class="btn btn-secondary" onclick="window.location.href='<?=base_url("Purchase");?>'">Cancel</button>
