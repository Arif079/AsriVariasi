...
<body>
    ...
    <div class="wrapper clearfix" >
        <div style="form-row" > 
            ...
            <tr>
                <td style="border:none;font-size:12px;">No Invoice</td>
                <td style="border:none;font-size:12px;">:</td>
                <td style="border:none;font-size:12px;" colspan="2"><?=$firstNtrn?></td>
            </tr>
            ...
            <tr>
                ...
                <td style="border:none;font-size:12px">:</td>
                <td style="border:none;font-size:12px"colspan="2"><?=$fetch->supplier?></td>
            <tr> 
            <tr>
