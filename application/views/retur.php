        ...
        <div class="content mt-3">
            <div class="card">
                <div class="card-header">
                    <a href="<?=base_url("retur/new");?>" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah</a>
                </div>
                <div class="card-body">
        ...
        <script>
                ...
                $("body").on("click",".btn-view",function(){
                    ...
                    jQuery.getJSON("<?=base_url("retur/detail");?>/"+id,function(data){
